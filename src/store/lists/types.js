...
export const REMOVE_LIST_REQUEST = 'REMOVE_LIST/pending';
export const REMOVE_LIST_SUCCESS = 'REMOVE_LIST/fulfilled';
export const REMOVE_LIST_FAILURE = 'REMOVE_LIST/rejected';
